<x-site-layout title="تفاصيل المستشفى">
    <div class="body-content hospital-details-page">
            ...
            <div class="row mt-4">
                <div class="col-lg-9">
                    <div class="owl-carousel hospital-details-slider owl-slider mt-32">
                        @foreach (($hospital->images ?? [$hospital->image]) as $image)
                    ...
                    <div id="cs-tabs" class="list-group cs-tabs">
                      ...
                      <div data-bs-spy="scroll" data-bs-target="#cs-tabs" data-bs-offset="0" class="scrollspy-example" tabindex="0">
                        <div id="list-item-1" class="tab-section">
                                    ...
                                    <g id="vuesax_bulk_info-circle" data-name="vuesax/bulk/info-circle" transform="translate(-366 -254)">
                                      <g id="info-circle" transform="translate(366 254)">
                                        ...
                                        <g id="Group_63665" data-name="Group 63665" transform="translate(0.399 -0.313)">
                                          <path id="Vector-2" data-name="Vector" d="M1,8a.971.971,0,0,0,1-.923V.923A.971.971,0,0,0,1,0,.971.971,0,0,0,0,.923V7.077A.971.971,0,0,0,1,8Z" transform="translate(11 6.313)" fill="#F4A261"/>
                            ...
                            <p>{{ $hospital->about ?? 'لا يوجد وصف متاح حالياً.' }}</p>
                            ...
                            <div class="d-flex flex-wrap gap-lg-5 gap-3 mt-3">
                                ...
                                @empty
                                <span class="black-color">لا توجد خدمات مضافة.</span>
                                @endforelse
                            </div>
                            ...
                            <div class="d-flex flex-wrap gap-lg-5 gap-3 mt-3">
                                @foreach (explode('،', $hospital->facilities ?? '') as $facility)
                                <span class="black-color">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <g id="vuesax_bulk_arrow-circle-right" data-name="vuesax/bulk/arrow-circle-right" transform="translate(-492 -252)">
                                          <g id="arrow-circle-right">
                            ...
                            <div class="d-flex flex-wrap gap-lg-4 gap-3 mt-4">
                                <div class="count-card">
                                    <p>{{ $hospital->founded_year ?? '—' }}</p>
                                    <p>سنة التأسيس</p>
                                </div>
                                <div class="count-card">
                                    <p>{{ number_format($hospital->staff_count ?? 0) }}</p>
                                    <p>طاقم العمل</p>
                                </div>
                                <div class="count-card">
                                    <p>{{ number_format($hospital->doctors_count ?? 0) }}</p>
                                    <p>عدد الأطباء</p>
                                </div>
                                <div class="count-card">
                                    <p>{{ number_format($hospital->operations_count ?? 0) }}</p>
                                    <p>عدد العمليات</p>
                                </div>
                                <div class="count-card">
                                    <p>{{ number_format($hospital->beds_num ?? 0) }}</p>
                                    <p>عدد الأسرة</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <h4>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g id="Medical_Case" data-name="Medical Case" transform="translate(-2 -2)">
                                      ...
                                      <path id="Path_776" data-name="Path 776" d="M11.625,11.208a1.208,1.208,0,0,1,2.417,0v2.417h2.417a1.208,1.208,0,1,1,0,2.417H14.042v2.417a1.208,1.208,0,0,1-2.417,0V16.042H9.208a1.208,1.208,0,0,1,0-2.417h2.417Z" transform="translate(1.166 1.555)" fill="#F4A261" fill-rule="evenodd"/>
                                    </g>
                                  </svg>
                                  التخصصات
                            </h4>
                        ...
                        <div id="list-item-3" class="tab-section">
                            <h4>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g id="Stethoscope" transform="translate(-2 -2)">
                                      ...
                                      <path id="Path_809" data-name="Path 809" d="M5.2,4.4a.8.8,0,0,0-.8.8v4a4.8,4.8,0,1,0,9.607,0v-4a.8.8,0,0,0-.8-.8h-.4a1.2,1.2,0,0,1,0-2.4h.4a3.2,3.2,0,0,1,3.2,3.2v4A7.205,7.205,0,0,1,2,9.205v-4A3.2,3.2,0,0,1,5.2,2h.4a1.2,1.2,0,0,1,0,2.4Z" transform="translate(0 0)" fill="#F4A261" fill-rule="evenodd"/>
                                      <path id="Path_810" data-name="Path 810" d="M19.6,13.8a1.2,1.2,0,1,0-1.2-1.2A1.2,1.2,0,0,0,19.6,13.8Zm0,2.4A3.6,3.6,0,1,0,16,12.6,3.6,3.6,0,0,0,19.6,16.205Z" transform="translate(2.795 1.397)" fill="#F4A261" fill-rule="evenodd"/>
                                    </g>
                                  </svg>
                                  الأخصائيين
                            </h4>
                            <div class="specialists-slider-section">
                                <div class="owl-carousel specialists-slider owl-slider mt-32">
                                    @forelse ($hospital->specialists as $specialist)
                                    ...
                                    @empty
                                    <div class="general-card specialist-card v2">
                                        <div class="general-card-body">
                                            <h4>لا يوجد أخصائيون بعد</h4>
                                        </div>
                                    </div>
                                    @endforelse
                                </div>
                            ...
                            <h4>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20.78" height="24" viewBox="0 0 20.78 24">
                                    <g id="location" transform="translate(-431.12 -189.75)">
                                      ...
                                      <path id="Vector-2" data-name="Vector" d="M7.374,3.687A3.687,3.687,0,1,1,3.687,0,3.687,3.687,0,0,1,7.374,3.687Z" transform="translate(437.829 196.084)" fill="#F4A261"/>
                                    </g>
                                  </svg>                                                            
                                  الخريطة                            
                            </h4>
                            <figure class="map">
                                <img src="build/assets/images/Location.png" alt="" srcset="">
                            </figure>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="form-hospital">
                        ...
                        @auth
                        <form action="{{ route('quote.start', $hospital) }}" method="get">
                            <div class="form-group mb-2">
                                <label for="">الاسم كاملا</label>
                                <input type="text" class="form-control cs-input" name="patient_name" value="{{ auth()->user()->name }}" placeholder="الاسم كاملا">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">البريد الالكتروني</label>
                                <input type="email" class="form-control cs-input" name="patient_email" value="{{ auth()->user()->email }}" placeholder="البريد الالكتروني">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">رقم الجوال</label>
                                <input type="text" class="form-control cs-input" name="patient_phone" value="{{ auth()->user()->phone }}" placeholder="رقم الجوال">
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control cs-input" name="disease" placeholder="ادخل المرض">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">الوصف</label>
                                <textarea name="disease_description" id="" class="form-control cs-input" cols="30" rows="5" placeholder="ادخل وصف مختصر..."></textarea>
                            </div>
                              <button type="submit" class="btn cs-btn v2 w-100 mt-4">أرسل الطلب</button>
                        </form>
                        @else
                        <p class="mb-3">سجّل الدخول أو أنشئ حساباً لطلب عرض سعر والحصول على استشارة مجانية.</p>
                        <a href="{{ route('login') }}" class="btn cs-btn v2 w-100">تسجيل الدخول</a>
                        <a href="{{ route('register') }}" class="btn cs-btn w-100 mt-2">إنشاء حساب</a>
                        @endauth
                    </div>
                </div>
            </div>
        ...
        <div class="other-hospitals">
            ...
            <div class="container">
                <div class="row mt-5">
                    @forelse ($otherHospitals as $other)
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ route('hospital-details', $other) }}" class="text-decoration-none">
                        <div class="hospital-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                            <figure>
                                <img src="{{ $other->image }}" alt="" srcset="">
                            </figure>
                            <div class="hospital-rate">
                                <div class="d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567" viewBox="0 0 20.08 18.567"><g id="Star" transform="translate(-3.355 -2.05)"><path id="Path" d="M9.158.578a.962.962,0,0,1,1.764,0L13.016,5.41a.96.96,0,0,0,.808.575l5.369.413a.956.956,0,0,1,.537,1.691l-4.038,3.32a.954.954,0,0,0-.321.967l1.243,5a.959.959,0,0,1-1.419,1.054L10.527,15.7a.964.964,0,0,0-.974,0L4.886,18.432a.959.959,0,0,1-1.419-1.054l1.243-5a.954.954,0,0,0-.321-.967L.35,8.089A.956.956,0,0,1,.888,6.4l5.369-.413a.96.96,0,0,0,.808-.575Z" transform="translate(3.355 2.05)" fill="#ffc542" /></g></svg>
                                    <span class="ml-1">{{ number_format($other->rates_avg_rating ?? 0, 1) }}</span>
                                </div>
                                <p>({{ $other->rates_count }}) تقييم | {{ $other->country }}، {{ $other->city }}</p>
                            </div>
                            <h4>{{ $other->name }}</h4>
                        </div>
                        </a>
