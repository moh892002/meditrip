<x-site-layout title="ملفي الشخصي">
                            ...
                            <div class="profile-form form">
                                <form action="{{ route('user-info.update') }}" method="post">
                                    ...
                                    <div class="upload-img">
                                        <input type="hidden">
                                        <figure>
                                            <img src="build/assets/images/img-after-upload.png" alt="" srcset="">
                                            <img src="build/assets/images/upload-img.svg" alt="" srcset="">
                                        </figure>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="icon-input">
                                                    ...
                                                    <input type="text" name="name" class="form-control custom-input" id="recipient-name" placeholder="أدخل الاسم كاملا" value="{{ old('name', $user->name) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="icon-input">
                                                    ...
                                                    <input type="email" class="form-control custom-input" name="email" id="email" placeholder="أدخل البريد الالكتروني" value="{{ old('email', $user->email) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="icon-input">
                                                    ...
                                                    <input type="text" class="form-control custom-input" name="phone" id="number_phone" placeholder="أدخل رقم الجوال" value="{{ old('phone', $user->phone) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="icon-input">
                                                    <span class="icon-i">
                                                      ...
                                                      <input type="text" name="country" class="form-control custom-input" placeholder="أدخل الدولة" value="{{ old('country', $user->country) }}">                                                  
                                                </div>
                                        </div>
                                        </div>
                                        <div class="col-lg-6">
    ...
    <div class="modal custom-modal success fade "id="changePassword" tabindex="-1" aria-labelledby="changePasswordLabel" aria-hidden="true">
                ...
                <div class="row justify-content-center">
                    <form action="">
                        <div class="col-10 offset-1">
                            <div class="mb-3">
                                <label for="address" class="col-form-label">كلمة المرور الحالية</label>
                                <div class="icon-input">
                                    <span class="icon-i">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                            <g id="vuesax_bulk_lock" data-name="vuesax/bulk/lock" transform="translate(-108 -316)">
                        ...
                        <div class="col-10 offset-1">
                            <div class="mb-3">
                                <label for="address" class="col-form-label">كلمة المرور الجديدة</label>
                                <div class="icon-input">
                                    <span class="icon-i">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                            <g id="vuesax_bulk_lock" data-name="vuesax/bulk/lock" transform="translate(-108 -316)">
                        ...
                        <div class="col-10 offset-1 mt-4">
                            <button type="submit" class="btn cs-btn v2 w-100">  حفظ</button>
                        </div>
                    </form>
                </div>
