<x-dashboard-layout title="إضافة عرض">
    <div class="container-fluid px-4">
        <h1 class="mt-4">إضافة عرض</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('offer_price') is-invalid @enderror" id="offer_price" name="offer_price" value="{{ old('offer_price') }}" min="0" step="0.01" required>
